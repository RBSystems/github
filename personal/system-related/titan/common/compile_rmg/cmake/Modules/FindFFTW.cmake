...
message(${FFTW_MPI_LIBRARIES})

if(NOT FFTW_MPI_LIBRARIES)
    message("atention")
    find_library (FFTW_MPI_LIBRARIES NAMES libfftw3_mpi)
endif(NOT FFTW_MPI_LIBRARIES)
