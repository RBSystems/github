...
void Fitting::fitmain()
{
    ...
    if (constraint->constraint_algebraic) {
        ...
        std::cout << "amat: " << amat << " M: " << M << " N: " << N <<" fsum: " << fsum << std::endl;
        memory->allocate(amat, M, N);
        memory->allocate(fsum, M);

        std::cout << "M: " << M << " N: " << N << " nat: " << nat <<" natmin: " << natmin << " ndata_used: " << ndata_used << " nmulti: " << nmulti << " maxorder: " << maxorder << " u: " << u << " f: " << f << " amat: " << amat << " fsum: " << fsum << std::endl;
